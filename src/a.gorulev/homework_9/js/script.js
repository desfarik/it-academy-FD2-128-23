...
(function App() {
                ...
                <div class="col-sm-6 col-12 d-flex">
                    <div class="card border-0 mt-5 flex-fill">
                        <div class="card-header py-3 d-flex justify-content-between">
                            ...
                            <span class="thisMonth">today</span>
    ...
    document.querySelector('#app').innerHTML = calendar;   
})()
...
function renderCalendar(m, y) {
    ...
    let table = document.querySelector('#dates');
    table.innerHTML = '';
    let s_m = document.querySelector('#s_m');
...
renderCalendar(month, year);
    ...
    $(function(){
        ...
        $(document).on('click', '.showEvent', function(){
            ...
            let eventDay = days[new Date(year, month, $(this).text()-1).getDay()];
